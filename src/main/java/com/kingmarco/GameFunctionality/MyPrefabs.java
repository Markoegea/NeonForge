...
public class MyPrefabs {
    ...
    public static GameObject generatePrefab(String file){
        ...
        walk.addFrame(playerSprites.getSprite(0), defaultFrameTime);
        walk.addFrame(playerSprites.getSprite(4), defaultFrameTime);
        walk.addFrame(playerSprites.getSprite(8), defaultFrameTime);
        walk.addFrame(playerSprites.getSprite(12), defaultFrameTime);
        walk.setLoop(true);

        StateMachine stateMachine = new StateMachine();
        stateMachine.addState(walk);
        stateMachine.setDefaultStateTitle(walk.title);
        prefab.addComponent(stateMachine);
        ...
        prefab.addComponent(rb);
        prefab.addComponent(pb);
        prefab.addComponent(new PlayerController());

        return prefab;
    }

    /* TODO Example using Mario
